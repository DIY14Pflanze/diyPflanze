...
Beides keine zufriedenstellende Lösung. Wieso lässt man die Pflanze sich nicht selbst gießen?
...
Hierunter fallen die Bodenfeuchtigkeit im Topf der Pflanze, die durchschnittliche Sonneneinstrahlung, die Luftqualität, der Nährstoffgehalt des Bodens sowie die Temperatur. 
...
\begin{itemize}
	...
	\item Das System soll über eine drahtlose Verbindung einstellbar sein. Diese Einschränkung gilt nur für die \emph{Arduino"~Variante}, da in der \emph{Sparversion} auf Grund energetischer Optimierung auf die Kommunikation verzichtet wird. Hier wird die Einstellung direkt im Code vorgenommen.
...
Im folgenden wird die \emph{Arduino"~Variante} ausführlich vorgestellt. 
...
%section
\input{arduinoVariante.tex}

%section
\input{sparversion.tex}
