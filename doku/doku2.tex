...
\section{Sparversion}
	...
	Auch hier wurde auf die Hardware von \glqq Arduino Nano\grqq\ gesetzt, diese wird aber nicht mehr mit der Arduino Software, sondern direkt Programmiert
	...
	Dadurch reduziert sich die Größe der Hauptplatine auf \begin{math} 50 mm \times 35 mm \end{math}.
	...
	Außerdem wird der Microcontroller nicht mehr über die USB-Schnittstelle programmiert, sondern mit Hilfe des AVRISP mkII \footnote{\href{http://www.atmel.com/tools/avrispmkii.aspx}{www.atmel.com/}}, da der Bootloader der Arduino Software deinstalliert wird. 
...
\end{table}
	...
	So ist dieser Nachbau bei ca. 15 \euro laut Tabelle \ref{Kosten für eine Sparversion Giesanlage}.
